...
def realizaEvolucion(stats):
    ...
    # Problema planteado como multiobjetivo (Comentar/Descomentar)
    toolbox = ConfiguracionSolucion.configure_solution_mo()
    # Problema planteado como restricción (Comentar/Descomentar)
    # toolbox = ConfiguracionSolucion.configure_solution_const()
